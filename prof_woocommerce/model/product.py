...
from openerp.addons.connector_woocommerce.model.product import ProductProductAdapter,ProductBatchImporter,ProductProductImporter
from openerp.addons.connector_woocommerce.model.product import ProductProductImporter,ProductImageImporter,ProductProductImportMapper
_logger = logging.getLogger(__name__)


class WooProductProduct(models.Model):
    _inherit = 'woo.product.product'
...
@woo
class ProductBatchImporter(ProductBatchImporter):
...
@woo
class ProductProductImporter(ProductProductImporter):
    _model_name = ['woo.product.product']
...
@woo
class ProductImageImporter(ProductImageImporter):
...
@woo
class ProductProductImportMapper(ProductProductImportMapper):
    _model_name = 'woo.product.product'
