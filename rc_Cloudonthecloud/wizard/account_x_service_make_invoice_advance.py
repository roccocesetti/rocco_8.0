...
class account_x_service_advance_payment_inv(osv.osv_memory):
    _name = "account.x.service.advance.payment.inv"
    _description = "account_x_service Advance Payment Invoice"
    ...
    def _prepare_advance_invoice_vals(self, cr, uid, ids, context=None):
        if context is None:
            context = {}
        sale_obj = self.pool.get('account.x.service')
