...
class res_company(orm.Model):
    ...
    _columns = {
        ...
        'send_pa': fields.selection([('pec','Pec'), ('web','Protale Web'), ('sdiwsdl12','Web service 1.2'), ('sdiwsdl20','Web service 2.0'), ('sdiftp','Sdi FTP')], 'Tipo invio fattura pa', size=32, required=True, ),
        'sdi_pec':fields.char('Pec trasmissione agenzia entrate', size=128, required=False, readonly=False),       
        'sdi_url':fields.char('Url agenzia entrate', size=128, required=False, readonly=False),       
        'sdi_wsdl12':fields.char('wdsl 1.2 agenzia entrate', size=128, required=False, readonly=False),       
        'sdi_wsdl20':fields.char('wdsl 2.0 agenzia entrate', size=128, required=False, readonly=False),       
        'sdi_ftp':fields.char('url ftp agenzia entrate', size=128, required=False, readonly=False),       
        'sdi_ftp_dir_dep':fields.char('cartella deposito ftp da agenzia entrate', size=128, required=False, readonly=False),       
        'sdi_ftp_dir_esito':fields.char('cartella esito ftp agenzia entrate', size=128, required=False, readonly=False),       
    }
