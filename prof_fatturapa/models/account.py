...
class welfare_fund_data_line(orm.Model):
    ...
    _columns = {
        ...
        'fund_nature': fields.selection([
            ...
            ('N6.1', 'inversione contabile (reverse charge)'),
            ('N6.2', 'inversione contabile (reverse charge)'),
            ('N6.3', 'inversione contabile (reverse charge)'),
            ('N6.4', 'inversione contabile (reverse charge)'),
            ('N6.5', 'inversione contabile (reverse charge)'),
            ('N6.6', 'inversione contabile (reverse charge)'),
            ('N6.7', 'inversione contabile (reverse charge)'),
            ('N6.8', 'inversione contabile (reverse charge)'),
            ('N6.9', 'inversione contabile (reverse charge)'),
            ('N7', 'N7 '),
...
class account_invoice(orm.Model):
    ...
    _columns = {
        ...
        'discount_rise_price_ids': fields.one2many(
            'discount.rise.price.pav12', 'invoice_id',
