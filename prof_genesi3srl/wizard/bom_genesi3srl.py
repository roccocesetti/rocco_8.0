...
class bom_genesi3srl(osv.osv_memory):
    _name = 'mrp.bom.dup'
...
class bom_line(osv.osv):
    ...
    def _get_cus_ns_npps(self,cr,uid,ids,field_name, arg,context=None):
        ...
        for line in  self.browse(cr,uid,ids,context=context):
            ...
            res[line.id] = line.product_qty* ((line.cu_stampo/line.Num_stp/line.Num_pz_stp)+line.standard_price)
        return res
    ...
    def on_change_product_id(self, cr, uid, ids, product_id, uom, product_qty,cu_stampo,Num_stp,Num_pz_stp,standard_price, context=None):
        """ Changes UoM
        ...
        cus_ns_npps = product_qty* ((cu_stampo/Num_stp/Num_pz_stp)+standard_price)
