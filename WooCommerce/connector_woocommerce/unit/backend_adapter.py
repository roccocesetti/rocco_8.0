...
class WooLocation(object):
    ...
    def __init__(self, location, consumer_key, consumre_secret,verify_ssl,
                 https_location,
                 https_version,
                 https_verify_ssl,
                 https_query_string_auth):
        
        self._location = location
        self.consumer_key = consumer_key
        self.consumer_secret = consumre_secret
        self.verify_ssl = verify_ssl
        self.https_location=https_location
        self.https_version=https_version
        self.https_verify_ssl=https_verify_ssl
        self.https_query_string_auth=https_query_string_auth
...
class WooCRUDAdapter(CRUDAdapter):
    ...
    def __init__(self, connector_env):
        ...
        woo = WooLocation(
            ...
            backend.verify_ssl,
            backend.https_location,
            backend.https_version,
            backend.https_verify_ssl,
            backend.https_query_string_auth,
    ...
    def _call(self, method, arguments):
        try:
            print 'enter_call_method',method,'arguments',arguments
            _logger.debug("Start calling Woocommerce api %s", method)
            
            if self.woo.location.find('https'):
                 api = API(
            ...
            print 'API_call_method',method,'arguments',arguments,api
            if api:
                ...
                try:
                    ...
                    print 'xxxxx_call_method',method,'arguments',arguments
                    #print '_call_result',result
                    #print '_call_safe_eval(api.get(method).content)',api.get(method).content
                except:
                    print 'error_call_method',method,'arguments',arguments
                    _logger.error("api.call(%s, %s) failed", method, arguments)
                    raise
                else:
                    print 'debug_call_method',method,'arguments',arguments
