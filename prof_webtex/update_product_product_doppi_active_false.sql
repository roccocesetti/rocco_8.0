update product_product pp2 set active=False from 
...
on spt.max_id=pp.id where pp.active=True and product_tmpl_id=1810
order by product_tmpl_id ) dup where pp2.id=dup.max_id
