...
class sale_order(models.Model):
    ...
    odd_parity_color = fields.Char('Odd Parrity Color')
    even_parity_color = fields.Char('Even Parity Color')
    text_color = fields.Char('Text Color')
    theme_color = fields.Char('Theme Color')
    theme_text_color = fields.Char('Theme Text Color')
    company_color = fields.Char("Company Name Color")
    customer_color = fields.Char("Customer Name Color")
    header_font = fields.Integer('Header Font Size(px)')
    footer_font = fields.Integer('Footer Font Size(px)')
    body_font = fields.Integer('Body Font Size(px)')
